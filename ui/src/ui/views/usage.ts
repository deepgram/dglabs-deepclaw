...
const usageStylesString = `
  ...
  .btn.usage-primary-btn {
    background: #13ef93 !important;
    border-color: #13ef93 !important;
  ...
  .btn.usage-primary-btn:hover {
    background: #0fb87a !important;
    border-color: #0fb87a !important;
  }
  .usage-primary-btn:disabled {
    background: rgba(19, 239, 147, 0.18);
  ...
  .usage-primary-btn[disabled] {
    background: rgba(19, 239, 147, 0.18) !important;
    border-color: rgba(19, 239, 147, 0.3) !important;
    color: #13ef93 !important;
    opacity: 1 !important;
  }
  .usage-secondary-btn {
    background: var(--bg-secondary);
  ...
  .usage-hour-cell.selected {
    ...
    box-shadow: 0 0 0 2px rgba(19, 239, 147, 0.2);
  }
  .usage-hour-labels {
    display: grid;
  ...
  .usage-hour-legend span {
    ...
    height: 10px;
    border-radius: 4px;
    background: rgba(19, 239, 147, 0.15);
    border: 1px solid rgba(19, 239, 147, 0.2);
  }
  ...
  .timeseries-svg .ts-bar.output { fill: #f04438; }
  .timeseries-svg .ts-bar.input { fill: #fec84b; }
  ...
  .sessions-card .session-bar-row.selected {
    border-color: var(--accent);
    background: var(--accent-subtle);
    box-shadow: inset 0 0 0 1px rgba(19, 239, 147, 0.15);
  }
  ...
  .sessions-card .session-bar-fill {
    background: rgba(19, 239, 147, 0.55);
  }
  .sessions-clear-btn {
    margin-left: auto;
  }
        ...
        <div class="usage-mosaic-section">
          ...
          <div class="usage-daypart-grid">
            ${stats.weekdayTotals.map((part) => {
              ...
              const bg =
                part.tokens > 0 ? `rgba(19, 239, 147, ${0.12 + intensity * 0.6})` : "transparent";
              return html`
        ...
        <div class="usage-mosaic-section">
          ...
          <div class="usage-hour-grid">
            ${stats.hourTotals.map((value, hour) => {
              ...
              const bg =
                value > 0 ? `rgba(19, 239, 147, ${0.08 + intensity * 0.7})` : "transparent";
              const title = `${hour}:00 · ${formatTokens(value)} tokens`;
              const border =
                intensity > 0.7 ? "rgba(19, 239, 147, 0.6)" : "rgba(19, 239, 147, 0.2)";
